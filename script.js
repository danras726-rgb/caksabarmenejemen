        ...
        <div className="h-screen w-full bg-cream-100 flex font-sans text-stone-700 selection:bg-brand-500/20 overflow-hidden">
            ...
            <main className="flex-1 flex flex-col min-w-0 bg-cream-100 page-shell h-screen relative transition-all duration-300">
                ...
                <div className="flex-1 relative w-full overflow-hidden">
                    ...
                    <div className={`absolute inset-0 overflow-y-auto p-4 md:p-8 custom-scrollbar ${activeTab === 'laporan' ? 'block' : 'hidden'}`}><div className="max-w-6xl mx-auto"><Laporan transactions={transactions} searchTerm={globalSearchTerm} setSearchTerm={setGlobalSearchTerm} /></div></div>
                    <div className={`absolute inset-0 overflow-y-auto p-4 md:p-8 custom-scrollbar ${activeTab === 'tanggungan' ? 'block' : 'hidden'}`}><div className="max-w-6xl mx-auto"><TanggunganPage items={tanggungan} saveItems={saveTanggunganToCloud} showToast={showToast} /></div></div>
